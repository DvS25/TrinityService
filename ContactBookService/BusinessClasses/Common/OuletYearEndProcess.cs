...
{
    public class OuletYearEndProcess
    {
        public static string YearEndStartProcess(string InputXml)
        {
            ...
            int YearEndAccountYearId = 0, LogInId = 0, EmpId = 0, OutletId = 0, CurrAccountYearId = 0;           
            ...
            try
            {
                ...
                if (ExtractXml.getNodeValues(InputXml, "OUTLETID") != "")
                {
                    OutletId = Convert.ToInt32(ExtractXml.getNodeValues(InputXml, "OUTLETID"));
                }
                if (ExtractXml.getNodeValues(InputXml, "ACCOUNTYEARID") != "")
                {
                ...
                CommonNodes += "<OUTLETID>" + OutletId + "</OUTLETID>";
                ...
                response = PerformSpecifiedAction.InvokeMethods("OUTLET_YEARENDPROCESS_ACCOUNTLIST_GET", InputXml);
        ...
        public static string OpeningAccountBalance(string Commonxml, int NextAccountYearId, int YearEndProcessId)
        {
            ...
            try
            {
                InputXml = "<SERVICEREQUEST><SERVICENAME>OUTLET_YEARENDPROCESS_ACCOUNTLIST_GET</SERVICENAME>";
                ...
                InputXml = PerformSpecifiedAction.InvokeMethods("OUTLET_YEARENDPROCESS_ACCOUNTLIST_GET", InputXml);
                XmlDocument doc = new XmlDocument();
                                ...
                                if (ds.Tables["DETAILS"].Rows.Count > 0)
                                {
                                    ...
                                    for (i = 0; i < TotalAccounts; i++)
                                    {
                                        ...
                                        if (i == (TotalAccounts - 1))
                                        {
                                            ...
                                            XMLValue = "<SERVICEREQUEST><SERVICENAME>OUTLET_YEARENDPROCESS_ACCOUNTLIST_GET</SERVICENAME>" + Commonxml;
                                            ...
                                            XMLValue = PerformSpecifiedAction.InvokeMethods("OUTLET_YEARENDPROCESS_ACCOUNTLIST_GET", XMLValue);
    ...
    public class CommonYearEndProcess
    {
        //------------------- Local variable declaration use for method which goes in threading 
        //private int LogInId;
        //private int EmpId;
        //private int OutletId;
        //private int CurrAccountYearId;
        //private int YearEndAccountYearId;
        private int NextAccountYearId;
        private string CommonNodes;
        private string AccountsList;
        private int YearEndProcessId;
        //private string UserType;
        //private string SecureKey;        

        //------------------- All property of local varible ----------------------------------         

        //public int prop_loginid
        //{
        //    get { return LogInId; }
        //    set { LogInId = value; }
        //}

        //public int prop_empid
        //{
        //    get { return EmpId; }
        //    set { EmpId = value; }
        //}

        //public int prop_outletid
        //{
        //    get { return OutletId; }
        //    set { OutletId = value; }
        //}

        //public int prop_curraccountyearid
        //{
        //    get { return CurrAccountYearId; }
        //    set { CurrAccountYearId = value; }
        //}

        //public int prop_yearendaccountyearid
        //{
        //    get { return YearEndAccountYearId; }
        //    set { YearEndAccountYearId = value; }
        //}

        public int prop_nextaccountyearid
        {
            get { return NextAccountYearId; }
            set { NextAccountYearId = value; }
        }

        public string prop_commonnodes
        {
            get { return CommonNodes; }
            set { CommonNodes = value; }
        }

        public string prop_accountslist
        {
            get { return AccountsList; }
            set { AccountsList = value; }
        }

        public int prop_yearendprocessid
        {
            get { return YearEndProcessId; }
            set { YearEndProcessId = value; }
        }


        //public string prop_usertype
        //{
        //    get { return UserType; }
        //    set { UserType = value; }
        //}
        //public string prop_securekey
        //{
